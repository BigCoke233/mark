...
<?php elseif($this->fields->type=='2'): ?>
  <a href="<?php $this->permalink() ?>" class="post-link">
    <div class="item post-item">
	  <div class="row">
	    <div style="height:160px;background:url('<?php $this->fields->banner(); ?>');background-repeat:no-repeat;background-size:cover" class="col-md-3 col-xs-3 post-banner-sm"></div>
