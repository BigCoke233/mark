	  ...
	  <div class="nav-content">
	    <ul class="nav navbar-nav">
		  ...
		  <?php else: ?>
            ...
            ->parse('<li><a class="mdui-ripple" href="{permalink}" data-pjax><i class="fa fa-paper-plane" aria-hidden="true"></i> {title}</a></li>'); ?>
		  <li><a class="mdui-ripple" data-pjax href="<?php $this->options->SiteUrl(); ?>"><i class="fa fa-home" aria-hidden="true"></i> 首页</a></li>
		  <?php endif; ?>
		</ul>
	  </div>
	</div>
